...
class patch_class(object):
        def __init__(self, age="", commit_msg="", url="", author="",status="TODO"):
                self.age = age
...
def parse_patch_content(content):
        ...
        while True:
                ...
                patch_list.append(patch_class(patch_age, real_commit_msg,
...
def get_patch_lists(version="", keywords="", outfile=""):
        ...
        with open(outfile, "w") as f:
                ...
                print("(%d)JSON format content has been written to %s"%(len(patch_json), outfile))
